...
public class QL
{
    ...
    public int ScoreForCompletedAction(SeededGameState sgs, CompletedAction action)
    {
        int result = 0;
    ...
    public void UpdateQValuesForPlayedCardsAtEndOfTurn(SeededGameState sgs)
    {
        ...
        foreach (var action in actions_completed_this_turn)
        {
            ...
            {
                int action_score = ScoreForCompletedAction(sgs, action);
    ...
    public int Heuristic(SeededGameState sgs)
    {
        ...
        // qltodo include value of cards from tavern that can be bought
